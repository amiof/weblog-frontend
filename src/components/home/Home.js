...
const Home = () => {
  return (
    <>
      <div
        className="grid grid-cols-10 grid-rows-8  border border-cyan-200 gap-2 "
        style={{ backgroundColor: backgroundColor }}
      >
        <aside className="row-span-full col-span-2 border border-yellow-300 ">
          <Aside></Aside>
        </aside>
        <header className="border border-red-500 col-span-8 ">
          <Navbar />
        </header>
